...
public class ReExcelEntity {
     ...
     * 主赛果
     */
    @ExcelProperty(value = "主赛果", index = 9)
    private String hostGameResult;
    /**
     * 和赛果
     */
    @ExcelProperty(value = "和赛果", index = 10)
    private String drawGameResult;
    /**
     * 客赛果
     */
    @ExcelProperty(value = "客赛果", index = 11)
    private String guestGameResult;
    /**
     * 第一排特征
     */
    @ExcelProperty(value = "第一排特征", index = 12)
    private String firstLine;
    /**
     * 第一排最高值
     */
    @ExcelProperty(value = "第一排最高值", index = 13)
    private double firstLineMax;
    /**
     * 第二排特征
     */
    @ExcelProperty(value = "第二排特征", index = 14)
    private String secondLine;
    /**
     * 第二排最低值
     */
    @ExcelProperty(value = "第二排最低值", index = 15)
    private double secondLineMin;
    /**
     * 第三排特征
     */
    @ExcelProperty(value = "第三排特征", index = 16)
    private String thirdLine;
    /**
     * 第三排最高值
     */
    @ExcelProperty(value = "第三排最高值", index = 17)
    private double thirdLineMax;
    /**
     * 365与初指平均值关系
     */
    @ExcelProperty(value = "365与初指平均值关系", index = 18)
    private String relationToInitialAvg;
    /**
     * 365与即时平均值关系
     */
    @ExcelProperty(value = "365与即时平均值关系", index = 19)
    private String relationToInstantAvg;
    /**
     * 返还率
     */
    @ExcelProperty(value = "返还率", index = 20)
    private String returnRate;
    /**
     * 主流、交易所极端情况
     */
    @ExcelProperty(value = "主流、交易所极端情况", index = 21)
